...
<xsl:stylesheet version="1.0"
  ...
  <!-- page size -->
  <xsl:param name="page-width">1240pt</xsl:param>
  <xsl:param name="page-height">1754pt</xsl:param>
  <xsl:param name="page-margin-top">118pt</xsl:param>
  <xsl:param name="page-margin-bottom">118pt</xsl:param>
  <xsl:param name="page-margin-left">100pt</xsl:param>
  <xsl:param name="page-margin-right">100pt</xsl:param>

  <!-- page header and footer -->
  <xsl:param name="page-header-margin">0.5in</xsl:param>
  <xsl:param name="page-footer-margin">50mm</xsl:param>
      ...
      <fo:static-content flow-name="page-footer">
        <fo:block space-after.conditionality="retain"
          ...
          <xsl:if test="$page-number-print-in-footer = 'true'">
          	...
          	<xsl:attribute name="padding">10px 0</xsl:attribute>
