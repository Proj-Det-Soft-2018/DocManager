...
public class HealthProcess implements Process {
	...
	public HealthProcess(Long id, boolean tipoOficio, String number,  Interested interested, Organization originEntity, Subject subject, Situation situation,  String observation) {
		this.id = id;
