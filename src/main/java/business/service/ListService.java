...
/**
 * Estabelece os métodos para gerenciamento de serviços de listas de organizações, situações
 * e assuntos.
 *
 */
public interface ListService {
   ...
   * @return lista de string com todas as situações que são possiveis de mudar,
   *         considerando a situação atual do processo.
   */
