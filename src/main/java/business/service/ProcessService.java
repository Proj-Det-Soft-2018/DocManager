...
public interface ProcessService {
   ...
   * @return Lista com todos os processos organizados de acordo com o que determina a 
   *         prioridade atual.
   * @throws DatabaseException Exceção lançada por inconsistência quando tenta pegar a lista
   *         no banco de dados.
   */
