...
public abstract class XmlToPdfBinary {
    ...
    public XmlToPdfBinary(Logger logger) {
	...
	try {
	    ...
	    Document xslDoc = db.parse(getXslPath().openStream());
	...
	String folderPath = getXslFolderPath();
    ...
    protected abstract URL getXslPath();

    protected abstract String getXslFolderPath();
}
