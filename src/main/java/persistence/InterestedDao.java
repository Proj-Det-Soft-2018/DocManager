...
public interface InterestedDao {
   ...
   * @throws DatabaseException Exceção lançada por inconsistência quando tenta salvar no
   *         banco de dados.
   */
   ...
   * @throws DatabaseException Exceção lançada por inconsistência quando tenta atualizar no
   *         banco de dados.
   */
   ...
   * @throws DatabaseException Exceção lançada por inconsistência quando excluir no
   *         banco de dados.
   */
   ...
   * @throws DatabaseException Exceção lançada por inconsistência quando tenta buscar no
   *         banco de dados.
   */
