...
public abstract class InterestedEditCtrl implements Initializable{
   ...
   *    Controlador da tela.
   * @param process
   *    Interessado selecionado para edição.
   */
   ...
   * inseridos no formulários e faz-se a tentativa de deleção, fechando a tela em caso de confirmação ou exi-
   ...
   * 
   * @return
   *    Objeto {@code Interested} com as informações coletadas.
   */
   ...
   * 
   * @param rootParent
   *    {@code javafx.scene.Parent} montado pelo {@code javafx.fxml.FXMLLoader}.
   * @return
   *    Cena da tela de edição.
   */
